...
if __name__ == '__main__':
    ...
    resume = False
    CLIP_GRAD = 5.0
    model_path = '/checkpoints/smoke/best.pth'
    Best_ACC = 0 #记录最高得分
    use_ema=True
    # 数据预处理7
    t = [
    ...
    dataset_train = datasets.ImageFolder('emotion/train', transform=transform)
    dataset_test = datasets.ImageFolder("emotion/val", transform=transform_test)
